...
class iso_cube:
    def __init__(self, dataset_title = '', output_path = '', cube_dimensions = 3):
        ...
        # ryan change
        self.pickle_dir = pathlib.Path(f'/home/idies/workspace/turb/data01_01/zarr/tmp_ryan/turbulence2-read_box_data/turbulence_output/turbulence_pickled')
    ...
    def get_iso_points(self, user_single_db_boxes_disk_data,
        ...
        for db_file in user_single_db_boxes_disk_data:
            ...
            for user_box_data in user_single_db_boxes_disk_data[db_file]:
                ...
                local_output_data.append((local_output_array, min_xyz, max_xyz, db_file))
